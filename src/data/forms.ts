...
export const FORM_CATEGORIES = [
  ...
  { id: 'fee-waiver', name: 'Fee Waivers', icon: 'BadgeDollarSign' },
...
export const COURT_FORMS: CourtForm[] = [
  ...
  },
  {
    ...
    description: 'Attachment for asking the court to order another party to pay attorney fees or costs.',
    category: 'custody',
    pdfUrl: '/forms/fl-319.pdf',
  },
  {
    id: 'fl-342',
    formNumber: 'FL-342',
  ...
  },
  {
    id: 'fl-343',
    formNumber: 'FL-343',
    title: 'Spousal, Domestic Partner, or Family Support Order Attachment',
    description: 'Order attachment for spousal, domestic partner, or family support terms.',
    category: 'support',
    pdfUrl: '/forms/fl-343.pdf',
  },
  {
    id: 'fl-435',
    formNumber: 'FL-435',
